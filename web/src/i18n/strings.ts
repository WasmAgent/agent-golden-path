...
const en: Dict = {
  ...
  'audit.downloadBundle': 'Download Bundle (.zip)',
  'audit.bundleTip': 'Report (HTML + Markdown + CSV), signed Trust Passport and verification notes',
  'audit.trustavoCta': 'This audit is rendered locally from signed AEP evidence. For a hosted, continuously verified dashboard over the same evidence chain, visit',
  'audit.trustavoLink': 'trustavo.com',
  'audit.from': 'From',
  'audit.to': 'To',
  'audit.load': 'Load',
